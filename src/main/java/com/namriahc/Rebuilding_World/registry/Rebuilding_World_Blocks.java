...
import com.namriahc.Rebuilding_World.block.custom.Block_steely_tree_sample;
...
public class Rebuilding_World_Blocks {
    ...
    public static class Blocks {
        ...
        public static final RegistryObject<Block> STEELY_TREE_SAMPLE = BLOCKS.register("steely_tree_sample", Block_steely_tree_sample::new);
    }
    public static class BlockItems {
        ...
        public static final RegistryObject<Item> STEELY_TREE_SAMPLE = BLOCK_ITEMS.register("shell_stone_slab"
                , () -> new BlockItem(Blocks.STEELY_TREE_SAMPLE.get(), new Item.Properties()
                ));
    }
}
